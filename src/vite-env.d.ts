...
// ─── Versioned module declarations ──────────────────────────────────────────
// Figma Make exports components using version-pinned specifiers.
// TypeScript needs these module declarations to resolve them without errors.
// Vite aliases (in vite.config.ts) redirect these to the actual packages.
// ─────────────────────────────────────────────────────────────────────────────
